                ...
                <table width="700" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td style="padding:20px; text-align:center;">
                            <h1 style="color:#a0da59; margin:10px; line-height:1;">@t('auth.confirmation.subject')</h1>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table align="center" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td style="background-color:#BAFF68; border-radius:5px; text-align:center;">
                                        <a href="{{ $url }}"
                                            style="display:block; padding:12px 24px; color:#000000; text-decoration:none; font-weight:500; font-size:14px;">@t('auth.confirmation.verify_account')</a>
                                    </td>
                                </tr>
                            </table>
