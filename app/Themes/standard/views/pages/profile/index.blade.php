            ...
            <article class="profile" data-profile-id="{{ $user->id }}" itemscope itemtype="https://schema.org/Person">
                <header class="profile__banner-wrapper">
                    <div class="profile__banner-wrapper-inner">
                        <img src="{{ url($user->banner) }}" alt="{{ __('profile.banner_alt', ['name' => $user->name]) }}"
                            class="profile__banner" loading="lazy" data-profile-banner="{{ $user->banner }}"
                        ...
                        <div class="profile__hero">
                            <div class="profile__hero-avatar">
                                <img src="{{ url($user->avatar) }}"
                                    alt="{{ __('profile.avatar_alt', ['name' => $user->name]) }}" class="profile__avatar"
                                    ...
                                    <ul class="profile__roles-list" role="list">
                                        @foreach ($user->roles as $role)
                                            <li class="profile__role">
                                                <span class="profile__role-square" style="background: {{ $role->color }}"
                                                    aria-hidden="true">
                                                </span>
                                                    ...
                                                    @foreach ([8, 4, 12] as $colSize)
                                                        <div class="col-md-{{ $colSize }}">
                                                            <div class="skeleton tabs-skeleton w-100"
                                                                style="height: 200px"
                                                                aria-label="{{ __('profile.loading') }}" role="status">
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>
