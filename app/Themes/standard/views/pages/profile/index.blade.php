    ...
    <div class="container">
        <div class="row"></div>
            <div class="col-md-12">
                ...
                <article class="profile" data-profile-id="{{ $user->id }}" itemscope itemtype="https://schema.org/Person">
                    <header class="profile__banner-wrapper">
                        <div class="profile__banner-wrapper-inner">
                            <img src="{{ url($user->banner) }}" 
                                 alt="{{ __('profile.banner_alt', ['name' => $user->name]) }}" 
                                 class="profile__banner"
                                 loading="lazy" 
                                 data-profile-banner="{{ $user->banner }}"
                                 onerror="this.style.display='none'; this.nextElementSibling.style.display='block';" />
                            <div class="profile__banner-fallback" style="display: none; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); height: 200px; width: 100%;"></div>
                        </div>
                                                        ...
                                                        <a href="{{ $social->url }}" 
                                                           ...
                                                           itemprop="sameAs">
                                                            <div class="profile__socials-item-icon">
                                                                <x-icon path="{{ $social->socialNetwork->icon }}" aria-hidden="true" />
                                                            </div>
                                                        </a>
                                                    </li>
                                                @endif
                                    ...
                                    <x-tab-body name="profile-tabs">
                                        @foreach ($tabs as $key => $tab)
                                            <x-tab-content name="{{ $tab['path'] }}"
                                                ...
                                                @endif
                                                <div class="row gx-3 gy-3" role="region" aria-label="{{ __('profile.loading_content') }}">
