...
window.WidgetEditor = class Widget {
    static get enableLineBreaks() {
        return true;
    }
    ...
    row: {
        ...
        config: {
            tools: {
                ...
                delimiter: Delimiter,
                card: {
                    class: window.CardEditor,
                    tunes: ['col'],
                },
                widget: {
                    class: window.WidgetEditor,
                    tunes: ['col'],
                },
                col: {
