...
@push('content')
    ...
    <form data-form="edit" data-page="currency" enctype="multipart/form-data">
        @csrf
        ...
        <div class="position-relative row form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="currency" name="currency" placeholder="RUB" value="{{ $currency->code }}"
                    required>
            </div>
        </div>
        ...
        <div class="position-relative row form-group">
            ...
            <div class="col-sm-9">
                <input type="number" step="0.01" id="minimum_value" name="minimum_value" placeholder="10.00"
                    value="{{ $currency->minimum_value }}" required>
            </div>
        </div>
                    ...
                    @foreach ($payments as $gateway)
                        <div class="form-checkbox">
                            <input class="form-check-input" name="gateways[{{ $gateway->id }}]" type="checkbox"
                                ...
                                @if ($currency->hasPayment($gateway)) checked @endif>
