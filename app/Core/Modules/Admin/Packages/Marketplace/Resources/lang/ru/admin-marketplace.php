...
return [
    ...
    'labels' => [
        ...
        'updates_available' => 'Обновления',
        'clear_filters' => 'Сбросить фильтры',
        'overview' => 'Обзор',
        'sort_featured' => 'Рекомендуемые',
        'sort_name' => 'По имени',
        'sort_free' => 'Сначала бесплатные',
    ],
    'categories' => [
        'all' => 'Все',
    ...
    'messages' => [
        ...
        'rollback_success' => 'Модуль успешно откачен',
        'concurrent_marketplace_operation' => 'Уже выполняется другая установка или обновление с маркетплейса. Подождите и повторите попытку.',
        'invalid_zip' => 'Скачанный файл не является корректным ZIP-архивом или слишком мал.',
        'directory_not_writable' => 'Каталог отсутствует или недоступен для записи: :path',
        'download_unauthorized' => 'Площадка отклонила скачивание модуля. Проверьте ключ Flute в основных настройках и привязку домена/IP в личном кабинете на flute-cms.com. :reason',
        'download_url_not_allowed' => 'URL скачивания не разрешён (хост должен совпадать с зеркалами маркетплейса).',
    ],
];
