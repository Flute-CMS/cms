<x-alert type="info" withClose="false" class="mb-0">
    {!! __('admin-social.edit.minecraft') !!}
</x-alert>
...
<x-forms.field>
    ...
    <x-fields.input name="settings__id" id="settings__id"
        ...
        placeholder="{{ __('admin-social.edit.minecraft_id_placeholder') }}" />
</x-forms.field>
...
<x-forms.field>
    ...
    <x-fields.input name="settings__secret" id="settings__secret" type="password"
        ...
        placeholder="{{ __('admin-social.edit.minecraft_secret_placeholder') }}" required />
</x-forms.field>
