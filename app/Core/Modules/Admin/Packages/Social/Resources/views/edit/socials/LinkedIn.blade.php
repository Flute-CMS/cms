...
<x-forms.field>
    ...
    <x-fields.input name="settings__id" id="settings__id"
        ...
        placeholder="{{ __('admin-social.edit.linkedin_id_placeholder') }}" />
</x-forms.field>
...
<x-forms.field>
    ...
    <x-fields.input name="settings__secret" id="settings__secret" type="password"
        ...
        placeholder="{{ __('admin-social.edit.linkedin_secret_placeholder') }}" required />
</x-forms.field>
...
<x-forms.field>
    ...
    <x-fields.input name="settings__scope" id="settings__scope"
        value="{{ request()->input('settings__scope', $social ? ($social->getSettings()['scope'] ?? 'openid profile email') : 'openid profile email') }}"
