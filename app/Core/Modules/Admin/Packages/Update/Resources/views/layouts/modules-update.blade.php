        ...
        <div class="update-section" role="listitem">
            <div class="update-card">
                ...
                <div class="update-content">
                    @if (!empty($moduleUpdate['changelog_html']))
                        @include('admin-update::components.markdown', [
                            'html' => $moduleUpdate['changelog_html'],
                        ])
                    ...
                    @elseif(!empty($moduleUpdate['description']))
                        @include('admin-update::components.markdown', [
                            'markdown' => $moduleUpdate['description'],
                        ])
                    @endif
                </div>
                ...
                <div class="update-footer">
                    ...
                    <div
                        yoyo:vals='{"id": "{{ $moduleId }}", "version": "{{ $moduleUpdate['version'] }}", "type": "module"}'>
                ...
                <details class="update-history" id="module-history-{{ $moduleId }}"
                    data-history="module-history-{{ $moduleId }}">
                    <summary>
                                ...
                                <div class="timeline-item">
                                    <div class="timeline-header">
                                        ...
                                        <div class="timeline-actions"
                                            yoyo:vals='{"id": "{{ $moduleId }}", "version": "{{ $version['version'] }}", "type": "module"}'>
