            ...
            <div class="update-card">
                ...
                <div class="update-content">
                    @if (!empty($themeUpdate['changelog_html']))
                        @include('admin-update::components.markdown', ['html' => $themeUpdate['changelog_html']])
                ...
                <details class="update-history" id="theme-history-{{ $themeId }}" data-history="theme-history-{{ $themeId }}">
                    <summary>
