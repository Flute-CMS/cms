    ...
    htmx.defineExtension('loading-states', {
        onEvent: function (name, evt) {
            if (name === 'htmx:beforeRequest') {
                // Проверяем наличие атрибута для отключения Loading-states
                if (evt.target.hasAttribute('data-disable-loading-states')) {
                    return; // Не обрабатываем Loading-states
                }
                ...
                loadingStateEltsByType['data-loading'].forEach(function (
                    sourceElt,
                ) {
                ...
                loadingStateEltsByType['data-loading-class-remove'].forEach(
                    function (sourceElt) {
                        ...
                        getLoadingTarget(sourceElt).forEach(function (
                            targetElt,
                        ) {
                            queueLoadingState(
                                sourceElt,
