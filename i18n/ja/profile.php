...
return [
    ...
    'two_factor' => [
        'title' => '二要素認証',
        'description' => '追加のセキュリティ層でアカウントを保護します。',
        'status_enabled' => '有効',
        'status_disabled' => '無効',
        'last_enabled' => ':date に有効化',
    ],
    'social_binded' => 'ソーシャルネットワークが正常にリンクされました！',
    'verification_warning' => '追加機能にアクセスするには、メールアドレスを確認してください。<a href=":link">確認</a>',
    'admin_actions' => [
        'add_balance' => '残高を追加',
        'remove_balance' => '残高を削除',
        'ban_user' => 'ユーザーをBANする',
        'unban_user' => 'ユーザーのBANを解除',
        'verify_user' => 'メールを確認',
        'unverify_user' => 'メール確認を解除',
        'clear_sessions' => 'セッションをクリア',
        'current_balance' => '現在の残高',
        'amount' => '金額',
        'amount_placeholder' => '金額を入力',
        'max_amount' => '最大：:amount',
        'ban_reason' => 'BAN理由',
        'ban_reason_placeholder' => 'BAN理由を入力',
        'ban_until' => 'BANまで',
        'ban_until_hint' => '永久BANの場合は空白のままにしてください',
        'balance_added' => '残高が追加されました：:amount',
        'balance_removed' => '残高が削除されました：:amount',
        'user_banned' => 'ユーザーがBANされました',
        'user_unbanned' => 'ユーザーのBANが解除されました',
        'user_verified' => 'メールが確認されました',
        'user_unverified' => 'メール確認が削除されました',
        'sessions_cleared' => 'ユーザーセッションがクリアされました',
        'cant_ban_self' => '自分自身をBANすることはできません',
        'cant_clear_own_sessions' => '自分自身のセッションをクリアすることはできません',
        'unban_confirm' => 'このユーザーのBANを解除してもよろしいですか？',
        'clear_sessions_confirm' => 'このユーザーのすべてのセッションをクリアしてもよろしいですか？',
    ],
    'verify_email' => 'メールを確認',
];
