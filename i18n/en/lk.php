<?php return [
    "page" => [
        ...
        "you_pay" => "Amount to pay"
    ],
    "success" => [
        "title" => "Success",
        "success_payment" => "Payment successful!",
        "success_payment_desc" => "Your balance has been successfully replenished! You can go to the main page and use the funds.",
    ],
    "error" => [
        "title" => "Failure",
        "fail_payment" => "Payment not completed!",
    ...
    "promo_amount" => "Bonus for replenishment: :value :currency",
