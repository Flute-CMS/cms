<?php return [
    ...
    "open" => "Ochish",
    "accept" => "Qoʻllash",
    "not_paid" => "Toʻlanmagan",
    "paid" => "Toʻlangan",
    "start_tour" => "Qoʻllanmani boshlash!",
    "maintenance_mode" => "Saytimizda texnik ishlar olib borilmoqda!",
    "createdAt" => "Yaratilgan sana",
    "created_at" => "Yaratilgan sana",
    "updatedAt" => "Oʻzgartirilgan sana",
    "updated_at" => "Oʻzgartirilgan sana",
    "are_you_sure" => "Ishonchingiz komilmi?",
    "confirm_text" => "Tasdiqlash",
    "learn_more" => "Koʻproq bilish",
    "or" => "Yoki",
    "and" => "Va",
    "enter_value" => "Qiymatni kiriting",
    "internal_server_error" => "Kutilmagan server xatosi yuz berdi",
    "online" => "Onlayn",
    "was_in_hour" => "Taxminan bir soat oldin onlayn edi",
    "was_in_online" => "Oxirgi onlayn :time",
    "user" => "Foydalanuvchi",
    "block" => "Bloklash",
    "reason" => "Sababi",
    "you_are_blocked" => "Siz quyidagi sababga koʻra saytimizda bloklangansiz: :reason",
    "amount" => "Miqdor",
